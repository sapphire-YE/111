...
ColorPopupWidget::ColorPopupWidget(QWidget *parent) : QWidget(parent)
{
  ...
  m_systemColors = {
      ...
      QColor("#FFFFFF"), QColor("#F8F8F8"), QColor("#EDEDED"),
      QColor("#D9D9D9"), QColor("#BFBFBF"), QColor("#8C8C8C"),
      QColor("#595959"), QColor("#262626"), QColor("#000000"),
      QColor("#FFCCC7"), QColor("#FFA39E"), QColor("#FF7875"),
      QColor("#FF4D4F"), QColor("#F5222D"), QColor("#CF1322"),
      QColor("#A8071A"), QColor("#820014"), QColor("#5C0011"),
      QColor("#FFF1B8"), QColor("#FFE58F"), QColor("#FFD666"),
      QColor("#FFC53D"), QColor("#FAAD14"), QColor("#D48806"),
      QColor("#AD6800"), QColor("#874D00"), QColor("#613400"),
      QColor("#FAFA8C"), QColor("#FFFF00"), QColor("#FFFB8F"),
      QColor("#FFF566"), QColor("#FFEC3D"), QColor("#FADB14"),
      QColor("#D4B106"), QColor("#AD8B00"), QColor("#876800"),
      QColor("#613400"), QColor("#D3F261"), QColor("#B7EB8F"),
      QColor("#95DE64"), QColor("#73D13D"), QColor("#52C41A"),
      QColor("#389E0D"), QColor("#237804"), QColor("#135200"),
      QColor("#092B00"), QColor("#91D5FF"), QColor("#69C0FF"),
      QColor("#40A9FF"), QColor("#1890FF"), QColor("#096DD9"),
      QColor("#0050B3"), QColor("#003A8C"), QColor("#002766"),
      QColor("#F759AB"), QColor("#EB2F96"), QColor("#C41D7F"),
      QColor("#9E1068"), QColor("#780650")};
  ...
  for (int i = 0; i < m_systemColors.size(); ++i)
  {
    ...
    btn->setStyleSheet(QString("background:%1; border:1px solid #ccc;")
                           .arg(m_systemColors[i].name()));
    btn->setProperty("color", m_systemColors[i]);
    connect(btn, &QPushButton::clicked, this,
            &ColorPopupWidget::onColorBlockClicked);
  ...
  for (int i = 0; i < 8; ++i)
  {
    ...
    connect(btn, &QPushButton::clicked, this,
            &ColorPopupWidget::onRecentColorClicked);
