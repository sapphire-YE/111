...
class ShapeTriangle : public ShapeBase
{
public:
  ShapeTriangle(const QRect &rect);
  void paintShape(QPainter *painter) override; // 绘制三角形本身
...
private:
  QRect m_rect;
  QPolygon getPolygon() const; // 计算三角形的多边形点
}; 